...
public class Game {
	...
	public static enum GameState {
		INITIALIZING, OL_PRESENTS, TITLE, START_GAME, START_NEXT_LIFE, LIVES_PRESENTATION, PLAYING, MARIO_TRANSFORMING,
		LEVEL_CLEARED, TIME_UP, GAME_OVER, GAME_CLEARED
	}
	...
	public void retrieveEntities(Rectangle area, List<Entity> resultEntities) {
		...
		for (Entity entity : entities) {
			if (!(entity instanceof Camera) && !(entity instanceof Mario) && area.intersects(entity.getCollider())) {
